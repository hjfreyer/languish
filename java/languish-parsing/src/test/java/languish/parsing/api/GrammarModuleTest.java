...
public class GrammarModuleTest extends TestCase {
	...
	public void testSimpleLexer() {
		...
		List<String> actual =
				Lists.transform(lexer.parse("foo foo      foo"), Functions
						.toStringFunction());
	...
	public void testLexerWithWeirdDelimeter() {
		...
		List<String> actual =
				Lists.transform(lexer.parse("fooafooafoo"), Functions
						.toStringFunction());
	...
	public void testRegexLexer() {
		...
		List<String> actual =
				Lists.transform(lexer.parse("foo fooooooo      foooo"), Functions
						.toStringFunction());
	...
	public void testLexerLineEndComment() {
		...
		actual =
				Lists.transform(lexer.parse("foo foo //Commented    foo"), Functions
						.toStringFunction());
	...
	public void testRegexLexerOptionalSpace() {
		...
		List<String> actual =
				Lists.transform(lexer.parse("foofooooooo      foooofo"), Functions
						.toStringFunction());
	...
	public void testLexerMultipleTokens() {
		...
		List<String> actual =
				Lists.transform(lexer.parse("foo bar      foooo"), Functions
						.toStringFunction());
	...
	public void testCalculatorLexer() {
		...
		List<String> actual =
				Lists.transform(lexer.parse("(3+42) * 16  /3+2"), Functions
						.toStringFunction());
