...
public class StringTreeParser {
	...
	public static final List<Pair<String, String>> TOKEN_PAIRS = ImmutableList
			.of( //
					Pair.of("[", "\\["),
					Pair.of("]", "\\]"),
					Pair.of("STRING_LIT", "\"(((\\\\.)|[^\"\\\\])*)\""));
	...
	public static final GrammarModule STRING_TREE_GRAMMAR = new GrammarModule(
			"TREE",
	...
	ImmutableMap<String, Function<String, Object>> LEAVES = ImmutableMap
			.<String, Function<String, Object>> builder()
	...
	private static final//
	ImmutableMap<String, Function<List<Object>, Object>> INODES = ImmutableMap
			.<String, Function<List<Object>, Object>> builder()
			//
	...
	public static final SemanticModule STRING_TREE_SEMANTIC = new SemanticModule(
			StringTreeParser.LEAVES,
			StringTreeParser.INODES);
