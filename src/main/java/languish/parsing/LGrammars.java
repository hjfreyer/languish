...
//  }
//
//  public static final PrimitiveFunction PARSE_STATEMENT = new PrimitiveFunction.TwoArgDataFunction() {
//    @Override
...
//    }
//
//    GrammarModule grammar = new LiteralGrammarModule(nonterms)
//        .setExported("ROOT");
//
...
//  };
//
//  private static List<ITokenizerConfigurator> TOKEN_TYPES = Arrays
//      .<ITokenizerConfigurator> asList( //
...
//    if (node.isEmpty()) {
//      return ImmutableList.of("EMPTY_NODE");
//    } else if (node.isText()) {
...
//          value = ImmutableList.of(children);
//        }
//      }
//
//      return ImmutableList.of(tag, value);
