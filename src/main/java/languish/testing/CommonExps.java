...
public class CommonExps {
  ...
  public static final Tuple ADDL =
      app(OMEGA, // ========= RECURSIVE
          ...
          abs( // ============= LIST
          abs( // ============= ITEM
          app(app(prim(DataFunctions.BRANCH, prim(LObject.EQUALS, cons(
  ...
  public static final String ADDL_CODE =
      "[APP [ABS [APP [REF 1] [REF 1]]] [ABS [ABS [ABS [APP [APP [PRIM BRANCH [PRIM EQUALS [CONS [DATA []] [REF 2]]]] [CONS [REF 1] [DATA []]]] [CONS [APP [ABS [GET 1 [REF 1]]] [REF 2]] [APP [APP [APP [REF 3] [REF 3]] [APP [ABS [GET 2 [REF 1]]] [REF 2]]] [REF 1]]]]]]]]";
