...
public class MapsTest extends TestCase {
  ...
  public static final Tuple MAP_GET = //
      app(OMEGA, // recursive
          ...
          app(app(prim(DataFunctions.BRANCH, // IF
              prim(DataFunctions.EQUALS, cons(NULL, ref(3)))), // MAP == NULL
              ref(1)), // RETURN DEFAULT, ELSE
              app(app(prim(DataFunctions.BRANCH, // IF
                  // top of map key = KEY
                  prim(DataFunctions.EQUALS, cons(ref(2), app(CAAR, ref(3))))),
                  car(cdr(car(ref(3))))), // then return top of map val
  ...
  public static final String MAP_GET_CODE =
      "[APP [ABS [APP [REF 1] [REF 1]]] [ABS [ABS [ABS [ABS [APP [APP [PRIM [DATA BRANCH] [PRIM [DATA EQUALS] [CONS [DATA []] [REF 3]]]] [REF 1]] [APP [APP [PRIM [DATA BRANCH] [PRIM [DATA EQUALS] [CONS [REF 2] [APP [ABS [CAR [CAR [REF 1]]]] [REF 3]]]]] [CAR [CDR [CAR [REF 3]]]]] [APP [APP [APP [APP [REF 4] [REF 4]] [CDR [REF 3]]] [REF 2]] [REF 1]]]]]]]]]";
  ...
  public enum Tests implements LanguishTestList {
    ...
    // PUT
    PUT_SINGLE_ELEMENT(app(app(app(MAP_PUT, NULL), data(LSymbol.of("FIVE"))),
        data(FIVE)), //
        "[APP [APP [APP " + MAP_PUT_CODE
            + " [DATA []]] [DATA \"FIVE\"]] [DATA 5]]",
        null,
        null,
        Lists.of(Lists.of(LSymbol.of("FIVE"), FIVE))),
    ...
    PUT_DOUBLE_ELEMENT(app(app(app(MAP_PUT, PUT_SINGLE_ELEMENT.expression),
        ...
        null,
        null,
        Lists.of(Lists.of(LSymbol.of("FOUR"), FOUR), Lists.of(LSymbol
            .of("FIVE"), FIVE))),
    ...
    PUT_OVERWRITE(app(app(app(MAP_PUT, PUT_DOUBLE_ELEMENT.expression),
        ...
        null,
        null,
        Lists.of(Lists.of(LSymbol.of("FIVE"), THREE), Lists.of(LSymbol
            .of("FOUR"), FOUR), Lists.of(LSymbol.of("FIVE"), FIVE))),
    ...
    STORE_ABS(app(app(app(MAP_PUT, NULL), data(LSymbol.of("ADD_ONE"))),
        abs(prim(DataFunctions.ADD, cons(ref(1), data(LInteger.of(1)))))), //
    ...
    LOAD_ABS(app( //
        app(
            app(app(MAP_GET, STORE_ABS.expression), data(LSymbol.of("ADD_ONE"))),
            data(LSymbol.of("DEFAULT"))), data(LInteger.of(8))), //
